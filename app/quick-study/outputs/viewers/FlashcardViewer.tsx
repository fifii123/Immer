...
export default function FlashcardViewer({ output, selectedSource }: FlashcardViewerProps) {
 ...
 // Hide global UI elements during active study
 useEffect(() => {
   const hideElements = studyMode === 'study'
   
   // Hide navigation breadcrumb and playground buttons
   const style = document.createElement('style')
   style.id = 'flashcards-active-styles'
   ...
   return () => {
     const existingStyle = document.getElementById('flashcards-active-styles')
     if (existingStyle) {
     ...
     <div className="h-full flex flex-col p-8 overflow-y-auto">
      ...
      <div className="flex flex-wrap justify-center gap-4 mb-8">
         <Select value={selectedCategory} onValueChange={setSelectedCategory}>
           <SelectTrigger className="w-44 bg-white dark:bg-gray-800 border-2">
...
<Button
  ...
  onClick={shuffleDeck}
  className="flashcard-action-btn border-2 min-w-32"
>
